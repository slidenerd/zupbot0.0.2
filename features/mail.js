...
const sendMailFrom = "mypirateapp@gmail.com";
const mail_password = "xkdefyucfufdaaev";


mail.sendMail = function (req, res) {
    // create reusable transporter object using the default SMTP transport
    var transporter = nodemailer.createTransport('smtps://' + sendMailFrom + ':' + mail_password + '@smtp.gmail.com');
